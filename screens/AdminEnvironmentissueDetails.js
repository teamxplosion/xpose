...
class AdminEnvironmenatalIssueDetails extends Component {
  ...
  acceptPost(key) {
    ...
    const updateRef = Firebase.firestore().collection('environment').doc(key);
    updateRef.update({
      approved: true,
    }).then((docRef) => {
...
export default AdminEnvironmenatalIssueDetails;