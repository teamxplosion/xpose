...
class CriminalActivities extends Component {
    ...
    render() { 
        ...
        <ScrollView style={styles.container}>
                <TouchableOpacity style={styles.add} onPress={() => this.props.navigation.navigate('AddCriminalActivity')}>
                ...
                </TouchableOpacity>
            {
                ...
                this.state.boards.filter(item => item.approved === true).map((item, i) => (
                    ...
                    <View style={styles.detailButton}>
                        ...
                        onPress={() => {
                            this.props.navigation.navigate('CriminalActivityDetails', {
                            crimeId: item.key,
                        });}} />
                    </View>
...
export default connect(mapStateToProps)(CriminalActivities)
